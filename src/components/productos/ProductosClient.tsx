        ...
        <table style={{width:'100%',borderCollapse:'collapse',fontSize:13,minWidth:600}}>
          ...
          <tbody>
            {filtered.map(p=>{
              ...
              <td style={{padding:'8px 10px',borderBottom:'1px solid var(--borderl)'}}><span style={{fontSize:10,padding:'2px 6px',borderRadius:4,background:(p as any).tipo_producto==='reventa'?'rgba(30,100,180,.08)':'rgba(26,122,64,.08)',border:(p as any).tipo_producto==='reventa'?'1px solid rgba(30,100,180,.25)':'1px solid rgba(26,122,64,.25)',color:(p as any).tipo_producto==='reventa'?'#1050a0':'#1a7a40'}}>{(p as any).tipo_producto||'elaborado'}</span></td>
